...
$id = (int)$_GET['id'];
$sql = "SELECT l.*, u.full_name as seller_name, u.id_verified, u.user_id as seller_id, u.verification_status 
        FROM listing l 
...
if ($row = mysqli_fetch_assoc($result)) {
    ...
    $row['can_buy'] = isset($_SESSION['user_id']) && $_SESSION['user_id'] != $row['seller_id'];
